...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Search Customer by name,').fill('eyeruse ');
  await page.getByRole('row', { name: '8070448012227 019798591' }).page.locator("(//*[@type='button'])[5]").click();
