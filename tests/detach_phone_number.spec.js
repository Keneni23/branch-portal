...
test('test', async ({ page }) => {
    ...
    page.on('response', async (response) => {
      ...
      if (url.includes('https://sau.eaglelionsystems.com/v1.0/chatbirrapi/ldap/otpForDetachPhoneNumber')) {
  ...
  await page.getByText('Detach phone number from the').click();
...
/*
  ...
  await page.locator('.eagle-ui-pin-code-field').first().fill('2');
